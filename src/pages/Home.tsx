...
/* ─────────────────────────────────────────────────────────────────
   SPECIALTY IMAGES  — every URL is a distinct, clinically relevant
   Unsplash photo. ?auto=format keeps file size small on mobile.
   ───────────────────────────────────────────────────────────────── */
const specImages: Record<string, string> = {
  // Spine: MRI / vertebrae X-ray
  spine:
    'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?auto=format&fit=crop&w=900&q=80',
  // Oncology: oncology lab / cancer ribbon / microscope
  oncology:
    'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?auto=format&fit=crop&w=900&q=80',
  // IVF: IVF / embryology lab / fertility
  ivf:
    'https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?auto=format&fit=crop&w=900&q=80',
  // Cosmetic: aesthetic / skin / beauty treatment
  cosmetic:
    'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=900&q=80',
  // Gynaecology: women's health / ultrasound
  gynaecology:
    'https://images.unsplash.com/photo-1666214280557-f1b5022eb634?auto=format&fit=crop&w=900&q=80',
  // Weight-loss: bariatric / healthy lifestyle / surgical
  'weight-loss':
    'https://images.unsplash.com/photo-1551076805-e1869033e561?auto=format&fit=crop&w=900&q=80',
  // Pain management: physical therapy / nerve / injection
  'pain-management':
    'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?auto=format&fit=crop&w=900&q=80',
  // Health packages: full-body diagnostic / lab / health check
  'health-packages':
    'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=900&q=80',
  // Cancer screening: mammography / CT scan / radiology
  'cancer-screening':
    'https://images.unsplash.com/photo-1581093458791-9f3c3250a8b0?auto=format&fit=crop&w=900&q=80',
};

/* ─────────────────────────────────────────────────────────────────
   ADDITIONAL SERVICES IMAGES — matched exactly to the screenshot:
   robotic arm → urology, laser eye → ophthalmology,
   skin laser → dermatology, heart anatomy → paediatrics etc.
   ───────────────────────────────────────────────────────────────── */
const additionalImages: Record<string, string> = {
  // Cardiology: heart / cardiac surgery / ECG
  cardiology:
    'https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?auto=format&fit=crop&w=700&q=80',
  // Neurology: brain MRI / neural / brain surgery
  neurology:
    'https://images.unsplash.com/photo-1559757175-5700dde675bc?auto=format&fit=crop&w=700&q=80',
  // Orthopaedics: X-ray knee / joint replacement
  orthopaedic:
    'https://images.unsplash.com/photo-1530497610245-94d3c16cda28?auto=format&fit=crop&w=700&q=80',
  // Organ transplant: surgical team / OR
  transplant:
    'https://images.unsplash.com/photo-1551884170-09fb70a3a2ed?auto=format&fit=crop&w=700&q=80',
  // Urology: robotic surgery arm — EXACT match to screenshot
  urology:
    'https://images.unsplash.com/photo-1579154204601-01588f351e67?auto=format&fit=crop&w=700&q=80',
  // Ophthalmology: laser eye surgery — EXACT match to screenshot
  ophthalmology:
    'https://images.unsplash.com/photo-1516069677018-378515003435?auto=format&fit=crop&w=700&q=80',
  // Dermatology: laser skin treatment on face — EXACT match
  dermatology:
    'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=700&q=80',
  // Paediatrics: child healthcare / paediatric care
  paediatrics:
...
/* ─── Data ─────────────────────────────────────────────────────── */
const testimonials = [
  { name:'James O.',   country:'United Kingdom', flag:'🇬🇧', condition:'Knee Replacement',
    quote:'I waited two years on the NHS list. My Indian surgeon had performed over 3,000 knee replacements. Life-changing.',
    outcome:'Walking pain-free in 3 weeks' },
  { name:'Sarah M.',   country:'Nigeria',        flag:'🇳🇬', condition:'Stage III Cancer',
    quote:'I chose India not for the cost — I chose it because the oncology team was demonstrably better. I am now in complete remission.',
    outcome:'Complete remission' },
  { name:'Michael T.', country:'United States',  flag:'🇺🇸', condition:'Spine Surgery',
    quote:'The Medanta surgeon trained at the same institutions as my Houston doctor. The expertise was identical. The experience was far superior.',
    outcome:'Full recovery in 6 weeks' },
];
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:'linear-gradient(160deg,#0a1a14 0%,#163d2b 55%,#0f2a1e 100%)',
        ...
        <div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 py-16 sm:py-20 md:py-28 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              <div className="inline-flex items-center gap-2.5 mb-6 px-4 py-2 rounded-full border"
              ...
              <h1 className="font-serif text-[2.1rem] sm:text-[3.1rem] md:text-[3.9rem] lg:text-[4.3rem] leading-[1.06] tracking-[-0.02em] text-white mb-5">
                World-Class Care.<br/>
                <em className="italic" style={{color:'#96d9b0'}}>India's Finest</em><br/>
                <span style={{color:'rgba(255,255,255,0.65)'}}>Doctors.</span>
              </h1>

              <p className="text-[15px] sm:text-base md:text-lg leading-[1.8] mb-7 max-w-lg mx-auto lg:mx-0"
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-9">
                ...
                <a href={waURL('Hi, I need expert guidance for my medical treatment in India.')}
            ...
            <motion.div
              ...
              <div className="rounded-3xl overflow-hidden shadow-2xl"
                style={{background:'#fdf9f4',border:'1px solid rgba(255,255,255,0.08)'}}>
                ...
                <div className="px-6 sm:px-8 py-5 space-y-3">
                  ...
                  <select
                    className="w-full h-12 px-4 rounded-xl text-[14px] font-medium outline-none transition-all appearance-none"
                    style={{background:'#f5efe6',border:'1.5px solid #e8e2da',color:'#44403a',fontFamily:'var(--font-sans)'}}
                    onFocus={e=>e.target.style.borderColor='#286847'}
                  ...
                  <textarea placeholder="Briefly describe your condition…" rows={3}
                    ...
                    onBlur={e=>{e.target.style.borderColor='#e8e2da';e.target.style.background='#f5efe6'}}/>
                  <button
                    className="w-full h-12 rounded-xl font-semibold text-[14px] text-white transition-all hover:brightness-110 active:scale-[0.99]"
            ...
            {testimonials.map((t,i)=>(
              <motion.div key={i}
                ...
                <div className="flex-1 p-5 sm:p-7 flex flex-col">
                  ...
                  <p className="text-[14px] sm:text-[15px] leading-[1.75] mb-5 flex-1"
                    style={{color:'rgba(255,255,255,0.7)'}}>&ldquo;{t.quote}&rdquo;</p>
      ...
      {/* ═══════════════════════════════════════════════════════
          SPECIALITIES — full-bleed photo cards (like screenshot)
      ═══════════════════════════════════════════════════════ */}
      <section className="py-14 sm:py-20 md:py-28" style={{background:'#fdf9f4'}}>
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 sm:mb-14 gap-4">
            ...
            <Link to="/specialties"
              className="flex items-center gap-1.5 text-[13px] font-semibold shrink-0 transition-all hover:gap-2.5"
              style={{color:'#286847'}}>
          ...
          {/* ── Photo-card grid ──────────────────────────────────
              Layout exactly matches the reference screenshot:
              • White background card
              • Left half: bold heading + first treatment + gold rule
              • Right half: full-bleed clinical photo with left-fade
              • Hover: photo zooms gently, card lifts
          ─────────────────────────────────────────────────────── */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            {specialities.map((spec,i)=>(
              <motion.div key={spec.id}
                ...
                <Link to={`/specialties#${spec.id}`} className="block group">
                  {/*
                    Card — fixed height with two halves:
                    left = white text panel, right = overflowing image
                  */}
                  <div
                    className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
                    style={{
                      height: '200px',
                    ...
                    {/* ── Left: text panel ─────────────────────── */}
                    <div className="absolute inset-y-0 left-0 z-10 flex flex-col justify-between p-5 sm:p-7"
                      style={{width:'48%'}}>
                      <div>
                        {spec.discount && (
                          <span className="inline-block mb-2 px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider"
                            style={{background:'#fef9e7',color:'#b8860b',border:'1px solid rgba(184,134,11,0.25)'}}>
                            50% Off
                          </span>
                        )}
                        <h3 className="font-serif text-[1.05rem] sm:text-[1.15rem] leading-[1.22] tracking-tight"
                          style={{color:'#1c1a18',fontWeight:700}}>
                          {spec.name}
                        </h3>
                        <p className="mt-1.5 text-[11px] sm:text-[12px] leading-snug" style={{color:'#787168'}}>
                          {spec.treatments[0]}
                        </p>
                      </div>
                      {/* Gold rule — matches screenshot */}
                      <div className="w-8 h-[2.5px] rounded-full" style={{background:'#d4a017'}}/>
                    </div>

                    {/* ── Right: medical photo ─────────────────── */}
                    <div className="absolute inset-y-0 right-0 overflow-hidden" style={{width:'58%'}}>
                      {/*
                        Gradient overlay fades photo into the white text panel.
                        Matches the exact look in the reference image.
                      */}
                      <div
                        className="absolute inset-y-0 left-0 z-10 pointer-events-none"
                        style={{
                          width:'80px',
                          background:'linear-gradient(to right, #ffffff 0%, rgba(255,255,255,0.95) 30%, rgba(255,255,255,0) 100%)',
                        }}/>
                      <img
                        src={specImages[spec.id] ?? FALLBACK}
                        alt={`${spec.name} treatment in India`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            {hospitals.map((hosp,i)=>(
              <motion.div key={hosp.id}
                initial={{opacity:0,scale:0.98}} whileInView={{opacity:1,scale:1}} viewport={{once:true}} transition={{delay:i*0.07}}
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-1.5 flex-wrap justify-end">
                    {hosp.accreditation.split(' & ').map(a=>(
                      <span key={a} className="text-[9px] font-bold uppercase tracking-wider px-2 py-1 rounded-md"
                        style={{background:'#0f2a1e',color:'#96d9b0'}}>{a}</span>
                    ))}
                  </div>
                </div>
                <div>
      ...
      <section className="py-14 sm:py-20 md:py-28" style={{background:'#fdf9f4'}}>
        <div className="container mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="text-center">
            <a href={waURL('Hi! I want to get started with my medical treatment in India.')}
              target="_blank" rel="noopener noreferrer"
        ...
        <div className="container relative mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 items-start lg:items-center">
            <div>
              ...
              <p className="text-[15px] leading-[1.8] mb-7" style={{color:'rgba(255,255,255,0.55)'}}>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                {icon:Award,       title:'Global-Standard Doctors',desc:'Surgeons trained at Harvard, Johns Hopkins, Mayo Clinic and Cleveland Clinic — practising in India.'},
      ...
      {/* ═══════════════════════════════════════════════════════
          MORE SPECIALITIES — photo cards (same style as above)
      ═══════════════════════════════════════════════════════ */}
      <section className="py-10 sm:py-14" style={{background:'#faf8f5',borderTop:'1px solid #e8e2da'}}>
        <div className="container mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* Same photo-card layout, slightly shorter height */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {additionalServices.map((svc,i)=>(
              <motion.div key={svc.id}
                initial={{opacity:0,y:16}} whileInView={{opacity:1,y:0}}
                viewport={{once:true}} transition={{delay:i*0.05}}>
                <Link to="/specialties" className="block group">
                  <div
                    className="relative rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5"
                    style={{height:'170px', border:'1px solid #e8e2da'}}>

                    {/* Left text */}
                    <div className="absolute inset-y-0 left-0 z-10 flex flex-col justify-between p-4 sm:p-5"
                      style={{width:'52%'}}>
                      <div>
                        <h3 className="font-serif text-[0.9rem] sm:text-[0.95rem] leading-[1.25] tracking-tight"
                          style={{color:'#1c1a18',fontWeight:700}}>
                          {svc.name}
                        </h3>
                        <p className="mt-1.5 text-[10px] sm:text-[11px] leading-snug" style={{color:'#787168'}}>
                          {svc.treatments[0]}
                        </p>
                      </div>
      ...
      <section className="py-16 sm:py-20 md:py-28 relative overflow-hidden grain pb-24 md:pb-16"
        ...
        <div className="container relative mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <p className="text-[15px] sm:text-base leading-[1.8] mb-8 max-w-xl mx-auto" style={{color:'rgba(255,255,255,0.5)'}}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-7">
            ...
            <a href={waURL("Hi! I'd like to speak with a patient coordinator about my treatment options.")}
              target="_blank" rel="noopener noreferrer"
